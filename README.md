...
**当前交付：首个可运行 Windows DEMO A。** 已实现核心、金币、机炮、行军体、地形、三夜交战、胜负与重开。Godot 4.7.2 .NET＋纯 C# Simulation，.NET SDK 10.0.401。游玩、构建、范围与验证见 [DEMO A](DEMO-A.md)。
...
工具链探针与切片 A 已完成，下一步进入 B 工业运营。首个对外实机至少达到切片 C 的身份展示要求；A 的内部交战原型不算完整产品展示。设计库不等于首个版本全部实现。
